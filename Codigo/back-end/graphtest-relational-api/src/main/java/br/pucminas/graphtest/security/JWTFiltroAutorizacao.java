...
import static br.pucminas.graphtest.util.ConstantesTopicosUtil.JWT_FILTRO_AUTORIZACAO;
...
public class JWTFiltroAutorizacao extends BasicAuthenticationFilter {
    ...
    public JWTFiltroAutorizacao(AuthenticationManager authenticationManager, JWTComp jwtComp, CustomUserDetailsService userDetailsServiceImpl) {
