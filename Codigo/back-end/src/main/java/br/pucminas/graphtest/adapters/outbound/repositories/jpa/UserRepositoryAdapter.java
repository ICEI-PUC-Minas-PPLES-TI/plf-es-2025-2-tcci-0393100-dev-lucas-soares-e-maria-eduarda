...
public class UserRepositoryAdapter implements UserRepositoryPort {
    ...
    private final BasePersistenceMapper<User, JpaUserEntity> mapper;
     ...
     */
    public UserRepositoryAdapter(JpaUserRepository jpaUserRepository, BasePersistenceMapper<User, JpaUserEntity> mapper) {
