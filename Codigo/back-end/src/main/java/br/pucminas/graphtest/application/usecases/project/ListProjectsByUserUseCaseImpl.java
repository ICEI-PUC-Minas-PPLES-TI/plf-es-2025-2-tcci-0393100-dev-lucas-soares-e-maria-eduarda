 ...
 * autenticado.
 */
public class ListProjectsByUserUseCaseImpl implements ListProjectsByUserUseCasePort {
     ...
     */
    public ListProjectsByUserUseCaseImpl(ProjectRepositoryPort projectRepository, CurrentUserPort currentUserPort) {
