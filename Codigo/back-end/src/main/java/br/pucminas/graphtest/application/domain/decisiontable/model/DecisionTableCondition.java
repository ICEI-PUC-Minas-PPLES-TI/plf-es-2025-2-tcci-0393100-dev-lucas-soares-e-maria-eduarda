...
/**
 * Representa uma linha de condicao da tabela de decisao.
 */
public class DecisionTableCondition extends BaseEntity {
    ...
    public DecisionTableCondition(UUID id, UUID decisionTableId, String code, String label, int orderIndex) {
        this(id, decisionTableId, code, label, orderIndex, null, null);
    }

    public DecisionTableCondition(UUID id,
