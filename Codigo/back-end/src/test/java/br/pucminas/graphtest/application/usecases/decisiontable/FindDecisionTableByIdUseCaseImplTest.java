...
class FindDecisionTableByIdUseCaseImplTest {
    ...
    @InjectMocks
    private FindDecisionTableByIdUseCaseImpl useCase;

    @Test
    void shouldAuthorizeProjectAndReturnDecisionTable() {
        ...
        DecisionTableOutput output = useCase.execute(new DecisionTableByIdInput(PROJECT_ID, TABLE_ID));

        assertEquals(TABLE_ID, output.id());
